...
function Projects() {
  return (
    <section className=" py-20" id="projects">
      <div className="border-b-10 border-[#011b31] pb-[150px]">
          <div className="m-5 p-10   drop-shadow-[0_0_10px_#3B82F6]  ">
            <h1 className="text-center w-auto  font-light uppercase border-b-2 p-4 text-6xl md:text-8xl text-white mb-10   ">Projects</h1>


              <div className="   border-white border-2 rounded-2xl p-10 hidden md:flex">
                {/* Horizontal scroll container */}
              
                <div className="flex space-x-8  overflow-x-auto scrollbar-hide pb-10 ">
                  {/* smunting pa alala */}
          ...
          {/*Mobile */}
          <div className="    border-white border-2 rounded-2xl p-4 m-4 block md:hidden" >
            {/* Horizontal scroll container */}
          
            <div className=" space-y-8  overflow-y-auto scrollbar-hide pb-10 ">
              {/* smunting pa alala */}
                <div className="text-center flex  items-center justify-center text-white font-FD text-3xl ">
                  <h1>F</h1>
                  <h1>R</h1>
                  <h1>O</h1>
                  <h1>N</h1>
              ...
              {/* JQRTC PROJECT */}
              <div className="p-6 shrink-0 w-auto h-auto rounded-xl border drop-shadow-[0_0_8px_#87CEEB]  bg-[#003F7F]/30 text-white flex  flex-col   text-xl font-bold"
              >
                <img 
                src={JQRTC}
                alt="JQRTC" 
                className="w-auto h-[250px] border "/>
            ...
            {/* SWIRLS PROJECT */}
              <div className="p-6 shrink-0 w-auto h-auto rounded-xl border drop-shadow-[0_0_10px_#FF69B4]  bg-[#C71585]/30 text-white flex flex-col  text-xl font-bold"
              >
                <img 
                src={SWIRLS}
                alt="JQRTC" 
              ...
              {/* TUTORTAP PROJECT */}
              <div className="p-6 shrink-0 w-auto h-auto rounded-xl border drop-shadow-[0_0_10px_#0D75D9]  bg-[#005BBB]/30 text-white flex flex-col  text-xl font-bold"
              >
                <img 
                src={TUTORTAP}
                alt="JQRTC" 
            ...
            {/* smunting pa alala */}
                <div className="text-center flex  pl-6 items-center justify-center text-white font-FD text-5xl ">
                  <h1>U</h1>
                  <h1 >I</h1>
                  <h1 >/</h1>
                  <h1>U</h1>
            ...
            {/* CLASS BUDDY PROJECT */}
              <div className="p-6 shrink-0  w-auto h-auto rounded-xl border drop-shadow-[0_0_7px_#87CEEB]  bg-[#3B82F6]/30 text-white flex flex-col  text-xl font-bold"
              >
                <img 
                src={CLASSBUDDY}
                alt="JQRTC" 
              ...
              {/* ISHTAR PROJECT */}
              <div className="p-6 shrink-0  w-auto h-auto rounded-xl border drop-shadow-[0_0_7px_#005BBB]  bg-[#001F54]/30 text-white flex flex-col  text-xl font-bold"
              >
                <img 
                src={ISHTAR}
                alt="JQRTC" 
